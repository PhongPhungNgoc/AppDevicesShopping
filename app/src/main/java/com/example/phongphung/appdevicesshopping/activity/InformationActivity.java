...
public class InformationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarInformation = findViewById(R.id.toolbarInformaion);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng shop = new LatLng(20.980857, 105.787406);
        mMap.addMarker(new MarkerOptions().position(shop).title("Shop").snippet("Shopping Devices Center").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(shop).zoom(90).build();
